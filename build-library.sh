...
cp lib/guava-15.0.jar executor/library
cp -R src executor
cp -R examples executor
cd src
javac -source 1.6 -target 1.6 -classpath "../lib/processing-core-1.5.1.jar:../lib/guava-15.0.jar" org/dishevelled/processing/executor/*.java
